...
let earthImg, earthData, earthParticles = new THREE.Object3D(),
	...
	dotTexture = new THREE.TextureLoader().load('/uploads/user_upload/39231/dot.png'),
	coneImg = ['/uploads/user_upload/39231/lightray.jpg', '/uploads/user_upload/39231/lightray_yellow.jpg'],
...
function main () {
	...
	earthImg.src = '/uploads/user_upload/39231/earth.jpg'
	earthImg.onload = () => {
...
gl_FragColor = vec4( texColor.rgb * diffuse, _a );
	...
	let geometry = new THREE.SphereGeometry(1.3 * radius, 66, 44),
		map = new THREE.TextureLoader().load('/uploads/user_upload/39231/clouds.jpg')
